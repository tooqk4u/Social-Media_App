...
const userController = {
  ...
  //Get User by ID And thoughts included
  ...
  addFriend({ params }, res) {
    //add Friend to the User Friend list array
    User.findOneAndUpdate(
      ...
      .then((dbUserData) => {
        ...
        //add User to the friends list array
        User.findOneAndUpdate(
          { _id: params.friendId },
  ...
  removeFriend({ params }, res) {
    // remove user friend from the list
    User.findOneAndUpdate(
      { _id: params.userId },
      ...
      .then((dbUserData) => {
        ...
        // remove User from the friend list of friends.
        User.findOneAndUpdate(
          { _id: params.friendId },
